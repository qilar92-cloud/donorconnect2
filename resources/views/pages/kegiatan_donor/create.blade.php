...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Kegiatan Donor</h1>
    </div>
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card shadow mb-4">
                ...
                <form action="{{ route('kegiatan-donor.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="waktu" id="waktu" class="form-control"
                                placeholder="Contoh: 08:00 - 12:00" value="{{ old('waktu') }}" required>
                        </div>
                        ...
                        <div class="form-group mb-0">
                            ...
                            <textarea name="keterangan" id="keterangan" rows="4"
                                ...
                                placeholder="Masukkan keterangan kegiatan (opsional)">{{ old('keterangan') }}</textarea>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('kegiatan-donor.index') }}" class="btn btn-secondary">
